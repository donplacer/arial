	...
	public ArrayList<Producto> listado() {
		...
		try {
			...
			while (rs.next()) {
				...
				reg.setStock(rs.getInt(3));
				reg.setMarca(rs.getString(4));
				reg.setPrecioProCompra(rs.getDouble(5));
				reg.setPrecioProLista(rs.getDouble(6));
				reg.setIdcategoria(rs.getString(7));
				reg.setIdproveedor(rs.getInt(8));
				reg.setCodbarra(rs.getString(9));
				reg.setCodregistrosani(rs.getString(10));
